  ...
  const sceneInfo = [
    ...
    },
    {
      ...
      objs: {
        ...
        imagesPath: ["./images/sons.jpg", "./images/sons2.jpg"],
        images: [],
      },
      values: {
        // 하얀박스의 X좌표
  ...
  function playAnimation() {
    ...
    switch (currentScene) {
      ...
      case 3:
        ...
        values.rect2X[0] =
          values.rect1X[0] + recalculatedInnerWidth - whiteRectWidth; //시작점 + 브라우저가로길이 - 하얀박스 폭
        ...
        if (scrollRatio < values.rect1X[2].end) {
          ...
          if (
            ...
            objs.canvasCaption.transform = `translate3d(0, ${calcValues(
